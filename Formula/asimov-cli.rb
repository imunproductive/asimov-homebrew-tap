class AsimovCli < Formula
  ...
  homepage "https://github.com/imunproductive/asimov-cli"
  version "25.0.0-dev.2"

  on_macos do
    if Hardware::CPU.arm?
      # macOS ARM
      url "https://github.com/imunproductive/asimov-cli/releases/download/#{version}/asimov-macos-arm.gz"
      sha256 "af05128473c3dfda48e7740d2a456a7996a6391ac46a3ef0620cb803afaeb793"
    else
      # macOS Intel
      url "https://github.com/imunproductive/asimov-cli/releases/download/#{version}/asimov-macos-x86.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      # Linux ARM
      url "https://github.com/imunproductive/asimov-cli/releases/download/#{version}/asimov-linux-arm.gz"
      sha256 "e9ca2393fe6147a01f10a36bd162b8f014fcfc1e964bb65a33e6d0920b34960d"
    else
      # Linux Intel
      url "https://github.com/imunproductive/asimov-cli/releases/download/#{version}/asimov-linux-x86.gz"
